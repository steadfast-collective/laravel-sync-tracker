...
return [
    ...
    */
    ...
    // rows from being accidentally tracked without a source. Automatic
    // lifecycle tracking (created/updated/deleted) always targets the
    // sourceless lifecycle row and is not affected by this option.
